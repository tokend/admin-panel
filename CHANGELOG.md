...
## [1.10.1-rc.0] - 2019-09-16
### Added
- New sale type

#### Fixed
- A bug when a user can to choose both integration with stellar and erc20
...
[Unreleased]: https://github.com/tokend/admin-panel/compare/1.10.1-rcinc.0...HEAD
[1.10.1-rcinc.0]: https://github.com/tokend/admin-panel/compare/1.10.1-rc.2...1.10.1-rcinc.0
