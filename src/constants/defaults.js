...
export const DEFAULT_PRECISION = String(Sdk.base.Operation.ONE || 1000000).match(/0/g).length
...
export const DEFAULT_MAX_AMOUNT = Sdk.base.Operation.MAX_INT64_AMOUNT
