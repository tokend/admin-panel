      ...
      <div
        ...
        <template
          ...
          <template v-if="Array.isArray(detail)">
            <div>
              <p class="details-reader__label secondary">{{ detailIndex }}:</p>
          ...
          <template v-else>
            <p class="details-reader__label secondary">{{ verbozify(detailIndex) }}</p>
    ...
    <template v-else>
      <div class="details-reader__block">
        <div class="details-reader__row">
          <p class="details-reader__label secondary">a</p>
